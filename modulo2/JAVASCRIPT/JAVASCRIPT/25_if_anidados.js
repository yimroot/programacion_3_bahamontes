...
let total_compra = Number(prompt('Ingrese el todal de la compra:'))
let respuesta = prompt('El cliente es miembro, ¿si o no?: ');

if (respuesta === 'si' && total_compra >50) {
    console.log("Descuento especial");
} else if(respuesta === 'no' && total_compra >50){
